...
def generateRequests():
	...
	if course != None and mainUrl != None:		
			...
			if r.status_code == 200:
				...
				for sublink in links2:
					...
					if "png" in imageName:
						...
						path = os.path.join(os.path.expanduser('~'), 'output', 'ServerImages', 'pngs/')
						...
						path = os.path.join(os.path.expanduser('~'), 'output', 'ServerImages', 'jpegs/')
